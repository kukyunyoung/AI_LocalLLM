...
>
> 또한 사용자가 업로드한 PDF파일의 내용을 목차로 요약해 줌으로써 구조화된 목차와 세부 내용을 안정적으로 생성할 수 있었고, 사용자가 긴 문서도 효율적으로 탐색·활용할 수 있도록 지원합니다.
> 
...
> ## 시행착오 및 개선
> PDF 업로드를 통한 목차 생성 과정에서는 API 토큰 제한으로 인해 한 번에 전체 문서를 처리할 수 없는 문제가 발생했습니다.
> 
